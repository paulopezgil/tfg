\begin{obs}
Considerem un procés estocàstic continu $\{X_t \vcentcolon t \in T\}$
amb valors a $\mathbb{R}$,
...
\item Fixats $t_1, t_2, \ldots, t_n \in T$, la funció $(X_{t_1}, X_{t_2}, \ldots, X_{t_n}) \vcentcolon \Omega \to \mathbb{R}^n$ definida per
      ...
      \]
      és un vector aleatori (que s'anomena \emph{vector aleatori de dimensió finita}).
\item Fixat $\omega \in \Omega$, la funció $X_{\text{\LARGE .}}(\omega)\vcentcolon T \to \mathbb{R}$
      definida per
      \[
