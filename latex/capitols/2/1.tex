...
\begin{obs} \label{obs-limit-feble} % 2.1.2
...
\emph{convergeix en probabilitat cap a} $a \in S$,
i escrivim $X_n \xrightarrow{P} a$, si $\{X_n\}_n$ convergeix en
probabilitat cap a la variable aleatòria constant $X \equiv a$.
És a dir, si per a tot $\varepsilon > 0$ es compleix que
\begin{equation*}
\lim_{n \to \infty} \P(\rho(X_n, a) > \varepsilon) = 0.
\end{equation*}
