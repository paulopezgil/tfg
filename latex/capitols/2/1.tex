...
A partir d'ara, treballarem en un espai mètric $(S, \rho)$ separable i complet,
junt amb la seva $\sigma$-àlgebra de Borel $\mathcal{S}$.
Denotarem per $\mathcal{P}(S)$ l'espai de totes les mesures de probabilitat en $(S, \mathcal{S})$.

És habitual dotar $\mathcal{P}(S)$ amb la anomenada \emph{topologia feble}
\footnote{Vegeu \cite{Dudley2002} - pàg 194.},
i metritzar-la mitjançant diverses mètriques.
Una de les més conegudes és la \emph{mètrica de Prokhorov},
per la qual la convergència de mesures de probabilitat
és equivalent a la convergència feble que veurem a continuació
\footnote{Per a més informació, vegeu \cite{Billingsley1999} - pàg 72 o
          \cite{Dudley2002} - cap. 11.3}.
