...
Per aquest motiu, en aquesta secció donarem una caracterització de l'ajustament en l'espai $C[0, \infty)$.
...
\begin{prova}
\textcolor{blue}{\cite{KaratzasShreve1991}, pàg 62}, \textcolor{blue}{\cite{Billingsley1999}, pàg 81}
\end{prova} 
\end{teo}
